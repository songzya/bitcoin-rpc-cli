...
type SearchService struct {
	...
	searchSource               *elastic.SearchSource // q
	source                     interface{}
...
func (s *SearchService) SearchSource(searchSource *elastic.SearchSource) *SearchService {
...
func (s *SearchService) Collapse(collapse *elastic.CollapseBuilder) *SearchService {
...
func (s *SearchService) PostFilter(postFilter elastic.Query) *SearchService {
...
func (s *SearchService) Highlight(highlight *elastic.Highlight) *SearchService {
...
func (s *SearchService) Suggester(suggester elastic.Suggester) *SearchService {
...
func (s *SearchService) SortWithInfo(info elastic.SortInfo) *SearchService {
	s.searchSource = s.searchSource.SortWithInfo(info)
	return s
}

// SortBy adds a sort order.
func (s *SearchService) SortBy(sorter ...elastic.Sorter) *SearchService {
...
// and return as part of the search.
func (s *SearchService) DocvalueFieldWithFormat(docvalueField elastic.DocvalueField) *SearchService {
...
// and return as part of the search.
func (s *SearchService) DocvalueFieldsWithFormat(docvalueFields ...elastic.DocvalueField) *SearchService {
...
func (s *SearchService) Rescorer(rescore *elastic.Rescore) *SearchService {
...
type SearchResult struct {
	...
	Shards          *elastic.ShardsInfo   `json:"_shards,omitempty"`      // shard information
